...
/**
 * This screen has the same content as SimpleLazyVerticalGridRecomposableScreen except no value is
 * set for contentWindowInsets. By commenting out contentWindowInsets recomposition is not triggered
 * when scrolling through that list.
 */
@Composable
fun SimpleLazyVerticalGridBugFixScreen() {
